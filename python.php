...
<head>
	...
	<title>Python Blog - THEEXPONENTIAL</title>
...
<body>
	...
	<h3 style="color:  	dodgerblue; font-family:comic sans ms;"><br>POSTS</h3><br>
		...
		if ($result->num_rows > 0) {
			...
			while ($row = $result->fetch_assoc()) {
				echo  "<br><br><a href='blog-post-python.php?id=" . $row['id'] . "'>" . $row["TITLE"] . "</a><br><hr>";
			}
		} else {
			echo "0 results";
		}
